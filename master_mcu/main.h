...
#define top_led_on() (P1OUT &= ~(BIT4))
#define top_led_off() (P1OUT |= (BIT4))
#define toggle_top_led() (P1OUT ^= BIT4)

#define bottom_led_on() (P1OUT &= ~(BIT5))
#define bottom_led_off() (P1OUT |= (BIT5))
#define toggle_bottom_led() (P1OUT ^= BIT5)
